...
Créé en février 1992, Log Alpha est à ranger dans les logiciels de tests de logique ou de QI. Il propose des séries de lettres à vous de trouver celle qui manque.

Le programme ne générait pas lui-même les séries. Un éditeur de jeu l'accompagne.

Je vous propose les codes sources des deux programmes de ce projet en attendant d'en refaire une version en ligne ou en Delphi.

Ce jeu a été développé en [Turbo Pascal](https://fr.wikipedia.org/wiki/Turbo_Pascal) pour fonctionner sous MS-Dos en mode texte.
